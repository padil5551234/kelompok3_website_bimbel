...
@includeIf('admin.paket_ujian.form')
@endsection
                ...
                .fail((errors) => {
                    ...
                    if (errors.status === 422) {
                        ...
                        if (errors.responseJSON && errors.responseJSON.errors) {
                            ...
                            toastr.error('Validasi gagal. Mohon periksa kembali data yang diinput.');
                        }
                    } else {
                        // Other errors
    ...
    function editData(url) {
        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-form [name=whatsapp_group_link]').val(response.whatsapp_group_link || '');
