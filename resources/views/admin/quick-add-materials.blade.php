...
@section('title', 'Quick Add Materials')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                Add materials directly to existing courses without creating a new course
            </p>
        </div>
    </div>

    <form id="quickAddForm" method="POST" action="{{ route('admin.integrated.quick-add.store') }}">
        @csrf

        <!-- Course and Tutor Selection -->
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-info text-white">
                <h5 class="card-title mb-0">
                    <i class="fas fa-cog mr-2"></i>Course & Instructor Settings
                </h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Select the course to add materials to</small>
                        </div>
                    </div>
