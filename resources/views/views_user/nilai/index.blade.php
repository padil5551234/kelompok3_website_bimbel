                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <h6 style="font-size: 80%" class="card-subtitle mb-1 text-muted">Waktu
                                                Pengerjaan</h6>
                                            <span>{{ \Carbon\Carbon::parse($currentUserUjian->waktu_mulai)->isoFormat('D MMM Y HH:mm:ss') }}
                                                -
                                                {{ \Carbon\Carbon::parse($currentUserUjian->waktu_akhir)->isoFormat('D MMM Y HH:mm:ss') }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <span>{{ $currentUserUjian->jawabanPeserta->where('jawaban_id', '!=', null)->count() }}
                                                / {{ $currentUserUjian->jawabanPeserta->count() }}</span>
                                        </td>
                                    </tr>
                                    @if ($ujian->tampil_nilai == 1 || ($ujian->tampil_nilai == 2 && \Carbon\Carbon::now() > $ujian->waktu_akhir) || ($ujian->tampil_nilai == 3 && \Carbon\Carbon::now() > $ujian->waktu_pengumuman))
                                        @if ($ujian->jenis_ujian == 'skd')
                                            @php
                                                $twk = $currentUserUjian->nilai_twk >= 65;
                                                $tiu = $currentUserUjian->nilai_tiu >= 80;
                                                $tkp = $currentUserUjian->nilai_tkp >= 166;
                                            @endphp
                                            <tr>
                                                <td>
                                                    <h6 style="font-size: 80%" class="card-subtitle mb-1 text-muted">Nilai
                                                        TWK</h6>
                                                    <span
                                                        class="badge bg-{{ $twk ? 'success' : 'danger' }}">{{ $currentUserUjian->nilai_twk }}
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <h6 style="font-size: 80%" class="card-subtitle mb-1 text-muted">Nilai
                                                        TIU</h6>
                                                    <span
                                                        class="badge bg-{{ $tiu ? 'success' : 'danger' }}">{{ $currentUserUjian->nilai_tiu }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <h6 style="font-size: 80%" class="card-subtitle mb-1 text-muted">Nilai
                                                        TKP</h6>
                                                    <span
                                                        class="badge bg-{{ $tkp ? 'success' : 'danger' }}">{{ $currentUserUjian->nilai_tkp }}</span>
                                                </td>
                                            </tr>
                                        @endif
                                        <tr>
                                            <td>
                                                <h6 style="font-size: 80%" class="card-subtitle mb-1 text-muted">Jumlah
                                                    Nilai</h6>
                                                <span>{{ $currentUserUjian->nilai }}</span>
                                            </td>
                                        </tr>
                                        @if ($ujian->jenis_ujian == 'skd')
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <h6 style="font-size: 80%" class="card-subtitle mb-1 text-muted">Status
                                                        Nilai</h6>
                                                    <span
                                                        class="badge bg-{{ $currentUserUjian->nilai >= 65 ? 'success' : 'danger' }}">{{ $currentUserUjian->nilai >= 65 ? 'Memenuhi ambang batas' : 'Tidak memenuhi ambang batas' }}</span>
                                                </td>
                                            </tr>
                                        @endif
                                    @endif
                ...
                <div class="col-lg-7">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-hover mt-3">
                            ...
                            <tbody>
                                @foreach ($currentUserUjian->jawabanPeserta as $key => $jawaban)
                                    <tr>
                                        <td>{{ $key + 1 }}.</td>
