...
@section('title', ($course ? 'Edit' : 'Create') . ' Course Materials - Tutor')
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">
                    ...
                    {{ $course ? 'Edit Course Materials' : 'Create Course Materials' }}
                </h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="mb-1">{{ $course ? 'Edit Course Materials' : 'Create New Course Materials' }}</h3>
                    <p class="text-muted mb-0">
                        {{ $course ? 'Update your course information and materials' : 'Fill in the details to create course materials' }}
                    </p>
                    @if($course)
            ...
            <form id="integratedForm" method="POST" action="{{ route('tutor.integrated.store') }}">
                @csrf
                @if($course)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="is_active" class="form-control">
                                            <option value="1" {{ ($course->is_active ?? true) ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ !($course->is_active ?? true) ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="chaptersContainer">
                                                    ...
                                                    <div class="card mb-3 material-section border-info" data-material="{{ $loop->index }}">
                                                        <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <a href="{{ route('tutor.integrated.material.edit', $material->id) }}"
                                                                   class="btn btn-outline-primary btn-sm"
                            ...
                            @else
                                ...
                                <div class="text-center py-5" id="emptyState">
                                    ...
                                    <p class="text-muted mb-4">Add your first chapter to start building your course materials</p>
                                    <button type="button" onclick="addChapter()"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="mb-1">{{ $course ? 'Update' : 'Create' }} Your Course Materials</h6>
                                        <small class="text-muted">
                                            {{ $course ? 'Existing materials will be preserved. New materials will follow proper ordering.' : 'Review all information before creating your course materials' }}
                                        </small>
                                    </div>
                                    <div>
                                        <button type="submit" class="btn btn-success btn-lg mr-3">
                                            <i class="fas fa-save mr-2"></i>
                                            {{ $course ? 'Update Materials' : 'Create Materials' }}
                                        </button>
                                        <a href="{{ route('tutor.integrated-dashboard') }}"
